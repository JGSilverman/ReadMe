...
namespace ReadMe.Data.Migrations
{
    ...
    [Migration("20220729140346_Stories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReadMe.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ReadMe.Models.Story", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ReadMe.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReadMe.Models.Story", b =>
                {
                    b.HasOne("ReadMe.Models.ApplicationUser", "Author")
                        .WithMany()
